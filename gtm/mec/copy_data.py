...
Keyed by work email. Each entry: three subject lines and three email bodies
(first touch plus two follow-ups). Every observation comes from that company's
own site copy or their contact's job title, per the honest-proof rule.

Style rules applied throughout:
  - No em dashes or en dashes anywhere. Plain punctuation only.
  - Short, everyday words. Nothing a busy owner has to re-read.
  - Every email gives something useful even if they never reply.
  - Closings vary. No repeated "Either way" / "Good luck" pattern.

Sender: Haroon. Cold. No message references a LinkedIn touch, since none happened.
Competitor rule: MEC Artworks is a mosaic house. Mosaic and tile prospects are told
that up front and offered a walkthrough, never a link to a competitor's tool.
"""
...
Want me to send you a short walkthrough?
""",
 "when there is nothing to put in the box", """
Stacy,
...
Your custom flow is still one of the better ones I have looked at this month.
""")
...
ai.mecartworks.com. Email code, five previews, nothing to cancel.
""",
...
add("jtheopistos@finerworks.com",
 "the commission your artists cannot preview", """
James,
...
Worth showing you?
""",
 "a COA for a piece that does not exist yet", """
James,
...
I would value your read on the output quality.
""",
 "one for the roadmap", """
James,
...
add("jennifer.brethack@photowall.com",
 "your simulator, for designs that do not exist yet", """
Jennifer,
...
Want to see how the two steps fit together?
""",
...
ai.mecartworks.com, email code, five previews, no card.
""",
...
Want me to show you where it would sit inside a private label flow?
""",
...
""",
 "is choosing really the slow part?", """
Ivars,
...
3,400 designs with a two day print run is a strong setup whatever you decide.
""")
...
The hospitality work in your diary section is a strong showcase.
""")
...
The Hotel La Gemma work is a strong reference to have.
""")
...
You will find it at ai.mecartworks.com. Five previews, no cost.
""",
 "you built configurators. what did you learn?", """
Giulia,
...
The Hotel Feldhof project is a good showcase.
""")
...
I would rather walk you through it than send you a competitor's link. Can I book fifteen minutes?
""",
...
Fifteen minutes on a screen share, no deck. Shall I send two or three times that suit you?
""",
...
Happy to show you myself. Would fifteen minutes work?
""",
 "software for your artists, software for your customer", """
Sal,
...
I would rather show you than send a competitor's link. Free for fifteen minutes this week?
""",
...
Fifteen minutes on a screen share and you would know. Want me to propose a time?
""",
...
Happy to walk you through it instead. Fifteen minutes on a call?
""",
...
I would rather demo it than send you to a competitor's site. Fifteen minutes, screen share. Want a couple of times?
""",
 "one last note", """
Christina,
...
Can I walk you through it? Fifteen minutes.
""",
...
I would rather show you directly than send a competitor's link. A quick screen share is all it takes. Want me to send times?
""",
...
I would rather walk you through it than send a competitor's link. Open to a short call?
""",
...
Fifteen minutes on a screen share and you would know whether it is worth raising internally. Want me to send a couple of times?
""",
...
Best of luck with the season's launches.
""")
...
""",
 "one image that works as a proposal and as content", """
Andrea,
...
Fifteen minutes on a screen share and you would see whether the quality is up to the brand.
""",
...
The Flora Springs project is a great piece of work.
""")
...
I would rather show you than send a link. Fifteen minutes on a screen share. Want a couple of times?
""",
 "have you looked at generated design already?", """
Paolo,
...
It is at ai.mecartworks.com. Five previews, no cost, code by email. You would know inside two minutes whether the output clears Fireclay's bar.
""",
...
The Foundry launch looks great.
""")
...
ai.mecartworks.com. Free, five previews, code by email.
""",
 "closing the loop", """
Randi,
...
The Whitney commission is a remarkable credit to have.
""")
...
Worth seeing how it might sit in front of Project Tile?
""",
...
Find it at ai.mecartworks.com. One code by email unlocks five previews.
""",
...
Project Tile is better than most of what this industry ships.
""")
...
Find it at ai.mecartworks.com. An email code gets you five previews. Two minutes will tell you whether it belongs next to the cards or nowhere near them.
""",
...
The Cedar and Moss collaboration is lovely work.
""")
...
I could not tell from your site how much custom work Seneca takes on. Open to a short call?
""",
...
ai.mecartworks.com shows what I mean in two minutes.
""",
 "the Mini Panels run", """
Connie,
...
If it does not do your glazes justice, I would want to know that too.
""",
...
Twenty plus years making the city's own tiles is a good thing to have built.
""")
...
ai.mecartworks.com, no cost, five previews, code by email. Two minutes will tell you whether it handles your glazes properly.
""",
...
Would that be more useful before the meeting than during it?
""",
...
Glad to show you how it works. Twenty minutes, screen share.
""",
...
The DvF collaboration is great brand work.
""")
...
add("kruthika@rugartisan.com",
 "300 colourways, and the design nobody drew", """
Kruthika,
...
""",
 "variation, versus designs that do not exist yet", """
Kruthika,
...
Happy to walk you through it. Twenty minutes.
""",
...
The personalise tool is well built.
""")

add("hope@theperfectrug.com",
 "custom prices versus everyday prices", """
Hope,
...
ai.mecartworks.com. Five free previews, no signup wall.
""",
...
Best of luck with the partnerships work.
""")
...
""",
 "what does The Rug Plan cost per request?", """
Cassie,
...
The tool is ai.mecartworks.com. Email code, five previews, free.
""",
...
The Rug Plan is lovely service design.
""")

# ═══════════════════════════ STAINED GLASS (PARKED NICHE) ═══════════════════════════
...
ai.mecartworks.com, free, five previews, email code.
""",
 "Unity Temple does not need my help", """
David,
...
Best of luck with the renaissance.
""")
...
ai.mecartworks.com, free, five previews, email code only. Two minutes will tell you whether it is usable at your standard.
""",
...
Worth a quick call to find out?
""",
...
Best of luck with the next generation of it.
""")
...
Seeds of Summer is a beautiful collection.
""")
...
It lives at ai.mecartworks.com. Five free previews, no password. Two minutes will tell you whether it does the Gilded finish justice, and I suspect that is the real test.
""",
...
Building a print operation alongside a design studio is a genuinely smart structure.
""")

add("hneurer@areaenvironments.com",
 "approving a wall they have never seen", """
Heather,
...
We built the AI studio MEC Artworks put on their site. Want me to run one of your collections through it and send you the result?
""",
...
Paying artists a royalty on every piece sold in their name is a good thing to see in this industry.
""")

add("susansteinicke@usvinyl.com",
 "Murals and Graphics, before the first install", """
Susan,
...
Would it help to see one of your new pieces put into a real hotel corridor? I will send it over.
""",
...
""",
 "character on a wall, inconsistency on a sample", """
Bardia,
...
ai.mecartworks.com, free to try, five previews, email code.
""",
...
add("geoffrey@eazywallz.com",
 "Watercolor Forest, and the mural nobody made", """
Geoffrey,
...
It is at ai.mecartworks.com. Five previews, free, email code only.
""",
...
Good luck with the next Mural of the Month.
""")
...
""",
 "the same service, without the person", """
Tony,
...
ai.mecartworks.com gives you five previews for an email code.
""",
...
The RHG hotel lobby work is a good reference to have.
""")
...
If it does not do your glazes justice, that is worth knowing too.
""",
...
The David Heide collaboration is a good credit to have.
""")

add("caitlin@pophamdesign.com",
 "your simulators, and the pattern that is not in them", """
Caitlin,
...
Worth seeing how it might sit in front of the simulators?
""",
 "creating the pattern, not just colouring it", """
Caitlin,
...
The link is ai.mecartworks.com. Five previews, no subscription.
""",
...
The simulators are the best thing in this category.
""")
